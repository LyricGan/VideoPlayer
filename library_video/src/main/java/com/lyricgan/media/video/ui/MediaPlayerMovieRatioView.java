...
import com.lyricgan.media.video.MediaVideoView;
...
public class MediaPlayerMovieRatioView extends RelativeLayout {
    ...
    public interface MoiveRatioChangeListener {
        ...
        void onMovieRatioChange(int mode);
    }
    ...
    private void init(Context context) {
        ...
        View rootView = LayoutInflater.from(mContext).inflate(R.layout.blue_media_player_video_ratio_view, null);
    ...
    public void show() {
        ...
        mCurrentIndex++;
        if (mCurrentIndex > MediaVideoView.MOVIE_RATIO_MODE_4_3) {
            mCurrentIndex = 0;
        }
    }
    ...
    public void setMovieRatioChangeListener(MoiveRatioChangeListener movieRatioChangeListener) {
