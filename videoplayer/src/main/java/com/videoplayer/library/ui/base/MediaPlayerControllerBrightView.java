...
public class MediaPlayerControllerBrightView extends RelativeLayout {
    ...
    public void init(final Context context) {
        ...
        mSeekBrightProgress.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            @Override
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (Constants.DEBUG) {
                    Log.d(Constants.LOG_TAG, "tmpInt =" + tmpInt + ">>mWindow==" + mWindow);
                }
                // 当进度小于40时，防止太黑看不见的后果
                ...
                if (Constants.DEBUG) {
                    Log.d(Constants.LOG_TAG, "mContext =" + mContext + ">>mContext.getContentResolver()=" + mContext.getContentResolver());
                }
                // 根据当前进度改变亮度
